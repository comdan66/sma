...
<?php if ($tags = CaseTag::find ('all')) { ?>
    ...
    <?php foreach ($tags as $tag) { ?>
            <a href='<?php echo base_url (array ('cases', $tag->name));?>'><div class='item'><?php echo $tag->name;?></div></a>
   <?php  } ?>
        </div>
<?php } ?>
...
<?php if ($tags = AromaTag::find ('all')) { ?>
    ...
    <?php foreach ($tags as $tag) { ?>
            <a href='<?php echo base_url (array ('aromas', $tag->name));?>'><div class='item'><?php echo $tag->name;?></div></a>
   <?php  } ?>
        </div>
<?php } ?>
