      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
            <td>標題＊</td>
            <td class="textleft">
              <input type='text' name='title' value="<?php echo $new->title;?>" placeholder='請輸入標題' maxlength='100' pattern=".{1,100}" required title="輸入100個字元以內" />
              &nbsp;&nbsp;輸入100個字元以內
            </td>
          </tr>
          <tr>
            <td>封面＊</td>
            <td class="textleft">
              <img src="<?php echo $new->file_name->url ('80x80');?>" alt="" width="80" height="80">
              <hr/>
          ...
          <tr>
            <td>日期＊</td>
            <td class="textleft">
              <input type='text' name='date' value="<?php echo $new->date->format ('Y-m-d');?>" placeholder='請選擇日期' pattern="^(19|20)\d\d([- /.])(0[1-9]|1[012])\2(0[1-9]|[12][0-9]|3[01])$" required title="請輸入正確的時間格式 (ex: 1999-01-01)" />
              &nbsp;&nbsp;* 設定當天日期
            </td>
          </tr>
          <tr>
